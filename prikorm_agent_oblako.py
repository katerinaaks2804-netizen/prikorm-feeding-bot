...
async def run_agent():
    ...
    Напиши подробный, увлекательный и простой пост по мотивам этой статьи, адаптированный ДЛЯ РОДИТЕЛЕЙ (мам и пап) на РУССКОМ языке. 
    Пиши простыми словами, как дружелюбный детский нутрициолог. Избегай сложных медицинских терминов, аббревиатур и тяжелой статистики. 
    НЕ используй никаких HTML-тегов, знаков *, _, ` или < >. Только чистый текст.
    
    Форматируй текст строго по шаблону:
    📌 РУБРИКА: НАУЧНЫЙ ПРИКОРМ ДЛЯ МАМ
    
    [ПРИВЛЕКАТЕЛЬНОЕ НАЗВАНИЕ ДЛЯ РОДИТЕЛЕЙ КАПСЛОКОМ, НАПРИМЕР: КОГДА НА САМОМ ДЕЛЕ МОЖНО ДАВАТЬ РЕБЕНКУ ЯЙЦА?]
    
    🍏 О чем это исследование:
    (Простыми словами в 2-3 предложениях объясни суть: что изучали ученые и почему это важно для обычных мам и пап).
    
    💡 Главный вывод для родителей:
    (Понятный практический результат: четкие сроки введения продуктов, объемы в ложках или граммах, данные об аллергиях, переведенные на простой человеческий язык).
    
    📝 Как применить на практике:
    (Пошаговый совет маме: что именно делать на кухне или прикорме прямо сегодня, основываясь на этом исследовании).
    
    📑 Информация для вашего педиатра (если захотите обсудить):
    Оригинальное название: (Точное название статьи на английском)
    Прямая ссылка на исследование: (Интернет-ссылка на эту статью в PubMed)
    """
